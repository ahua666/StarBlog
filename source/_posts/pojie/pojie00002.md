...
搜索关键字 找到关键代码处
![](https://cdn.cbd.int/ahua666-panimg@1.0.56/img/20240618102936.png)
...
再往上看
![](https://cdn.cbd.int/ahua666-panimg@1.0.56/img/20240618102629.png)
发现他会判断Cookie,比对Cookie内容，比对后还会创建定时器进行接口验证
到了这里开始尝试编写脚本
开始的思路是将jq给拦截掉 让他方法失效
新建一个油猴脚本
![](https://cdn.cbd.int/ahua666-panimg@1.0.56/img/20240617165122.png)
